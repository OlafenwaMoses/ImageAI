...
Built with simplicity in mind, ImageAI 
    ...
    &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Eventually, <b>ImageAI</b> will provide support for a wider
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp To use <b>ImageAI</b> in your application developments, you must have installed the following 
 dependencies before you install <b>ImageAI</b> : <br> <br>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <span><b>- Python 3.5.1 (and later versions) </b> &nbsp &nbsp &nbsp &nbsp  <a href="" style="text-decoration: none;" >How to Install<a> (Support for Python 2.7 coming soon) </span> <br> 
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <span><b>- pip3 </b> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  <a href="" style="text-decoration: none;" >How to Install<a></span> <br>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <span><b>- Tensorflow 1.4.0 (and later versions) </b> &nbsp &nbsp &nbsp &nbsp  <a href="" style="text-decoration: none;" >How to Install<a></span> <br>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <span><b>- Numpy 1.13.1 (and later versions) </b> &nbsp &nbsp &nbsp &nbsp  <a href="" style="text-decoration: none;" >How to Install<a></span> <br>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <span><b>- SciPy 0.19.1 (and later versions) </b> &nbsp &nbsp &nbsp &nbsp  <a href="" style="text-decoration: none;" >How to Install<a></span> <br>

 <h3><b><u>Installation</u></b></h3>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp To install ImageAI, download the Python Wheel <a href="dist/imageai-1.0.1-py3-none-any.whl" ><b>
    ...
    <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>pip3 install C:\User\MyUser\Downloads\imageai-1.0.1-py3-none-any.whl</b></span> <br><br>


<h3><b><u>Using ImageAI</u></b></h3>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp ImageAI provides 4 different algorithms and model types to perform image prediction.
To perform image prediction on any picture, take the following simple steps.

&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 1) &nbsp &nbsp The 4 algorithms provided for
 image prediction include <b>SqueezeNet</b>, <b>ResNet</b>, <b>InceptionV3</b> and <b>DenseNet</b>. Each of these
  algorithms have individual model files which you must use depending on the choice of your algorithm. To download the
   ...
   &nbsp &nbsp &nbsp  <span><b>- <a href="" style="text-decoration: none;" >SqueezeNet</a> (Size = 4.82 mb, fastest prediction time and moderate accuracy) </b></span> <br>
   &nbsp &nbsp &nbsp  <span><b>- <a href="" style="text-decoration: none;" >ResNet</a></b> by Microsoft Research <b>(Size = 98 mb, fast prediction time and high accuracy) </b></span> <br>
   &nbsp &nbsp &nbsp  <span><b>- <a href="" style="text-decoration: none;" >InceptionV3</a></b> by Google Brain team <b>(Size = 91.6 mb, slow prediction time and higher accuracy) </b></span> <br>
   &nbsp &nbsp &nbsp  <span><b>- <a href="" style="text-decoration: none;" >DenseNet</a></b> by Facebook AI Research <b>(Size = 31.6 mb, slower prediction time and highest accuracy) </b></span> <br><br>
   ...
   After you download the model file of your choice, you will need to download one more file which will be a JSON file that contains the model
    ...
    &nbsp &nbsp &nbsp  <span><b>- <a href="imagenet_class_index.json" download style="text-decoration: none;" >imagenet_class_index.json</a> </b></span> <br> <br>
    &nbsp &nbsp &nbsp Great! Once you have downloaded these two files, start a new python project, and then copy these two files to your project
...
<br>
<span>
    &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The code above works as follows: <br>
     <b><pre>from imageai.Prediction import ImagePrediction
import os</pre></b>
<br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The code above imports the <b>ImageAI</b> library 
 and the python <b>os</b> class. <br>
<b><pre>execution_path = os.getcwd()</pre></b>
<br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The above line obtains the path to the folder that contains
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp In the lines above, we created and instance of the <b>ImagePrediction()</b>
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp In the above line, we defined 2 variables to be equal to the function
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The above line obtains each object in the <b>predictions</b> array, and also 
...
<h3><b><u>Using ImageAI in MultiThreading</u></b></h3>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp When developing programs that run heavy task on the deafult thread like User Interfaces (UI),
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp - You can create your prediction object, set its model type, set model path and json path
outside the new thread. <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  - The <b>.loadModel()</b> must be in the new thread and image prediction (<b>predictImage()</b>) must take place in th new thread.
<br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Take a look of a sample code below on image prediction using multithreading:
<pre><b>
from imageai.Prediction import ImagePrediction
import os
import threading
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp As a demonstration of the what you can do with ImageAI, we have 
...
<h3><b><u>Documentation</u></b></h3>
 <span> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The ImageAI library currently supports only image prediction via the <b>ImagePrediction</b>
  class. 
 ...
 <hr>
 <p>
     &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The <b>ImagePrediction</b> class can be used to perform image prediction
      in any python application by initiating it and calling the available functions below: <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- setModelTypeAsSqueezeNet()</b> &nbsp &nbsp &nbsp This function should be called should you 
      chose to use the SqueezeNet model file for the image prediction. You only need to call it once. <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- setModelTypeAsResNet()</b> &nbsp &nbsp &nbsp This function should be called should you 
      chose to use the ResNet model file for the image prediction. You only need to call it once. <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- setModelTypeAsInceptionV3()</b> &nbsp &nbsp &nbsp This function should be called should you 
      chose to use the InceptionV3Net model file for the image prediction. You only need to call it once. <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- setModelTypeAsDenseNet</b> &nbsp &nbsp &nbsp This function should be called should you 
      chose to use the DenseNet model file for the image prediction. You only need to call it once. <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- setModelPath()</b> &nbsp &nbsp &nbsp You need to call this function only once and parse the path to
       the model file path into it. The model file type must correspond to the model type you set. <br>
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- setJsonPath()</b> &nbsp &nbsp &nbsp You need to call this function only once and parse the path to
       the <b>imagenet_class_index.json</b> into it. <br>
       &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- loadModel()</b> &nbsp &nbsp &nbsp You need to call this function
        once only before you attempt to call the <b>predictImage()</b> function .<br>
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>- predictImage()</b> &nbsp &nbsp &nbsp To perform image 
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>Moses Olafenwa</b> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Website: </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://moses.specpal.science"> https://moses.specpal.science</a> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Twitter: </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://twitter.com/OlafenwaMoses"> @OlafenwaMoses</a> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Medium : </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://medium.com/@guymodscientist"> @guymodscientist</a> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Facebook : </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://facebook.com/moses.olafenwa"> moses.olafenwa</a> <br>
<br><br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>John Olafenwa</b> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Website: </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://john.specpal.science"> https://john.specpal.science</a> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Twitter: </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://twitter.com/johnolafenwa"> @johnolafenwa</a> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Medium : </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://medium.com/@johnolafenwa"> @johnolafenwa</a> <br>
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <i>Facebook : </i> &nbsp &nbsp &nbsp <a style="text-decoration: none;" href="https://facebook.com/olafenwajohn"> olafenwajohn</a> <br>
