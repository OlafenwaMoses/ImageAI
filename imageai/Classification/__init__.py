        ...
        * classification_speed (optional); Acceptable values are "normal", "fast", "faster" and "fastest"
        ...
        if (self.__modelLoaded == False):
            ...
            if(self.__modelType == "" ):
                ...
                model = tf.keras.applications.MobileNetV2(input_shape=(self.__input_image_size, self.__input_image_size, 3), weights=self.modelPath, classes = 1000 )
                ...
                try:
                    model = tf.keras.applications.ResNet50(input_shape=(self.__input_image_size, self.__input_image_size, 3), weights=self.modelPath, classes = 1000 )
                    self.__model_collection.append(model)
                    self.__modelLoaded = True
                except:
                ...
                try:
                    model = tf.keras.applications.DenseNet121(input_shape=(self.__input_image_size, self.__input_image_size, 3), weights=self.modelPath, classes = 1000 )
                    self.__model_collection.append(model)
                    self.__modelLoaded = True
                except:
                ...
                try:
                    model = tf.keras.applications.InceptionV3(input_shape=(self.__input_image_size, self.__input_image_size, 3), weights=self.modelPath, classes = 1000 )
                    self.__model_collection.append(model)
                    self.__modelLoaded = True
                except:
