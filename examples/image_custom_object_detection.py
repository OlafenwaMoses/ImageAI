...
PATH_IMAGE_DETECT = os.path.join(PATH_HERE, "image3new-custom.jpg")
...
def main(path_model, path_img, path_detect):
    ...
    detections = detector.detect_custom_objects(custom_objects=custom,
                                                input_source=path_img, output_image_path=path_detect,
